...
RSpec.describe TopicsController, type: :controller do
  ...
  context "member user" do
    before do
      user = User.create!(name: "1Bloccit User", email: "user1@bloccit.com", password: "helloworld", role: :member)
      create_session(user)
    end
  ...
  context "moderator user" do  #findme
    before do
  ...
  context "admin user" do
    before do
      user = User.create!(name: "Bloccit User2", email: "user2@bloccit.com", password: "helloworld", role: :admin)
      create_session(user)
    end
